...
class MobileTasksFilterSheet extends StatefulWidget {
  static const String clearFiltersKey = '__clear_filters__';

  const MobileTasksFilterSheet({super.key});

  @override
  State<MobileTasksFilterSheet> createState() => _MobileTasksFilterSheetState();
}

class _MobileTasksFilterSheetState extends State<MobileTasksFilterSheet> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      projectPro.getProjectFilterTaskAssignees();
      projectPro.getProjectSectionFilterOptions();

      final active = projectPro.activeTaskFilters;
      ...
      _clientIdController.text = active['client_id'] ?? '';
      _customerIdController.text = active['customer_id'] ?? '';
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Spacers.sb15(),
                    _input('Client ID', _clientIdController),
                    Spacers.sb15(),
                ...
                child: CustomButton(
                  ...
                  onTap: () {
                    ...
                    Navigator.pop(context, {
                      MobileTasksFilterSheet.clearFiltersKey: true,
                    });
                  },
                  stadium: false,
                  height: 43,
  ...
  Widget _assignedToDropdown() {
    final projectPro = context.watch<ProjectPro>();
    final assignedOptions = projectPro.projectFilterTaskAssigneeOptions;
