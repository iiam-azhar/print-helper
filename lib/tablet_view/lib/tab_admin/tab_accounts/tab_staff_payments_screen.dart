...
import 'package:print_helper/tablet_view/lib/tab_utils/formatter.dart';
...
class TabStaffPaymentsScreen extends StatefulWidget {
  final AccountModel account;
  final VoidCallback onBack;

  const TabStaffPaymentsScreen({
    super.key,
  ...
  @override
  State<TabStaffPaymentsScreen> createState() => _TabStaffPaymentsScreenState();
}

class _TabStaffPaymentsScreenState extends State<TabStaffPaymentsScreen>
  ...
  Future<void> _selectTime(BuildContext context, bool isFrom) async {
    final TimeOfDay? picked = await showTimePicker(
      context: context,
      initialTime: isFrom
          ? (_fromTime ?? const TimeOfDay(hour: 17, minute: 31))
          : (_toTime ?? const TimeOfDay(hour: 8, minute: 34)),
    );
    if (picked != null) {
      setState(() {
        if (isFrom) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            const Icon(Icons.manage_accounts_outlined, color: Colors.black87),
        ...
        if (provider.paymentCompensationLoad) {
          return Center(
            child: Padding(
              ...
              child: showLoader(centered: true),
            ),
          );
        }
  ...
  Widget _buildPerformanceTab() {
    return Consumer<AdminPro>(
      builder: (context, provider, child) {
        ...
        final formatCurrency = (num val) => '\$${val.toStringAsFixed(2)}';
                                        ...
                                        child: Container(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Text(
                                                _fromTime != null
                                                    ? '${(_fromTime!.hourOfPeriod == 0 ? 12 : _fromTime!.hourOfPeriod).toString().padLeft(2, '0')}:${_fromTime!.minute.toString().padLeft(2, '0')} ${_fromTime!.period == DayPeriod.am ? 'AM' : 'PM'}'
                                                    : formatTimeStr(
                                                        data.businessWorkingHourFromTime,
                                                      ),
                                                style: GoogleFonts.poppins(
                                                  fontSize: 15,
                                                  fontWeight: FontWeight.w600,
                                        ...
                                        child: Container(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Text(
                                                _toTime != null
                                                    ? '${(_toTime!.hourOfPeriod == 0 ? 12 : _toTime!.hourOfPeriod).toString().padLeft(2, '0')}:${_toTime!.minute.toString().padLeft(2, '0')} ${_toTime!.period == DayPeriod.am ? 'AM' : 'PM'}'
                                                    : formatTimeStr(
                                                        data.businessWorkingHourToTime,
                                                      ),
                                                style: GoogleFonts.poppins(
                                                  fontSize: 15,
                                                  fontWeight: FontWeight.w600,
                                    ...
                                    child: RichText(
                                      text: TextSpan(
                                        ...
                                        children: [
                                          ...
                                          const TextSpan(
                                            text:
                                                ' payout % applies to each rate card\'s client price for your account type. Volume tiers use this week\'s claim counts separately: ',
                                          ),
                                          TextSpan(
                                            text:
                                                '${data.weekWholesaleClaimCount}',
                                            style: GoogleFonts.poppins(
                                              fontWeight: FontWeight.bold,
                                              color: const Color(0xFF475569),
                                              fontSize: 10,
                                          ...
                                          const TextSpan(text: ' wholesale, '),
                                          TextSpan(
                                            text:
                                                '${data.weekRetailClaimCount}',
                                            style: GoogleFonts.poppins(
                                              fontWeight: FontWeight.bold,
                                              color: const Color(0xFF475569),
                                              fontSize: 10,
  ...
  Widget _buildDayRow(PerformanceDay day) {
    return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  children: [
                    const Icon(Icons.info, color: Color(0xFF3B82F6), size: 16),
                    const SizedBox(width: 12),
                    Expanded(
                      child: Text(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (entries.isEmpty)
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 12),
                            Text(
                              "No wholesale or retail entries for this day",
                              style: GoogleFonts.poppins(
                                fontSize: 13,
                                fontWeight: FontWeight.w600,
                                color: const Color(0xFF475569),
                            ...
                            const SizedBox(height: 4),
                            Text(
                              "Try a different day from the navigation above.",
                              style: GoogleFonts.poppins(
                                fontSize: 11,
                                color: const Color(0xFF94A3B8),
                              ),
                      ...
                      ...entries.map((entry) {
                        final isAvailable =
                            entry.status.toLowerCase() == 'available';
                        final isClaimed =
                            entry.status.toLowerCase() == 'claimed';
                        ...
                        return Container(
                          ...
                          child: Row(
                            children: [
                              Expanded(
                                flex: 1,
                                child: isAvailable && !isLocked && !(data.isDayClosed || data.isWeekClosed)
                                    ? Align(
                                        ...
                                        child: SizedBox(
                                          ...
                                          width: 24,
                                          child: Checkbox(
                                            value: _selectedWholesaleIds
                                                .contains(entry.id),
                                            onChanged: (val) {
                                              setState(() {
                                                if (val == true) {
                                                  _selectedWholesaleIds.add(
                                                    entry.id,
                                                  );
                                                } else {
                                                  _selectedWholesaleIds.remove(
                                                    entry.id,
                                                  );
                                                }
                                              });
                              ...
                              _buildTableCell(entry.client, flex: 2),
                              Expanded(
                                flex: 2,
                                child: Align(
                                  alignment: Alignment.centerLeft,
                              ...
                              _buildTableCell(entry.orderNo, flex: 2),
                              _buildTableCell(entry.jobNo, flex: 2),
                              Expanded(
                                flex: 2,
                                child: Align(
                                  alignment: Alignment.centerRight,
                                  child: isAvailable && !isLocked
                                      ? OutlinedButton.icon(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        _buildTableHeader('WEEK', flex: 2),
                        _buildTableHeader('EARNINGS', flex: 2),
                        _buildTableHeader('FLOOR', flex: 2),
                        _buildTableHeader('TOTAL', flex: 2),
                        _buildTableHeader('METHOD', flex: 2),
                        _buildTableHeader('TRANSACTION', flex: 2),
                        const SizedBox(width: 20),
                        _buildTableHeader('STATUS', flex: 2),
                        _buildTableHeader('ACTIONS', flex: 4),
                      ],
                    ),
                  ),
                  ...data.rows.map((row) {
