...
class DialogAddCustomer extends StatefulWidget {
  final int? clientId;
  const DialogAddCustomer({super.key, this.clientId});

  @override
  State<DialogAddCustomer> createState() => _DialogAddCustomerState();
}

class _DialogAddCustomerState extends State<DialogAddCustomer> {
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: CustomButton(
              title: formSubmitted ? "Saving..." : "Save Customer",
