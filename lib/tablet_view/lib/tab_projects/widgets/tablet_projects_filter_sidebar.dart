...
class TabletProjectsFilterSidebar extends StatefulWidget {
  static const String clearFiltersKey = '__clear_filters__';

  const TabletProjectsFilterSidebar({super.key});

  @override
  State<TabletProjectsFilterSidebar> createState() =>
      _TabletProjectsFilterSidebarState();
}

class _TabletProjectsFilterSidebarState
    extends State<TabletProjectsFilterSidebar> {
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildDropdown(
                    ...
                    context
                        .watch<ProjectPro>()
                        .projectFilterProjectAssigneeOptions,
            ...
            child: OutlinedButton(
              onPressed: () {
                ...
                Navigator.pop(context, {
                  TabletProjectsFilterSidebar.clearFiltersKey: true,
                });
              },
