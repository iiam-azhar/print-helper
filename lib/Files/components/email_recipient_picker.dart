...
class EmailRecipientPicker extends StatefulWidget {
  ...
  @override
  State<EmailRecipientPicker> createState() => _EmailRecipientPickerState();
}

class _EmailRecipientPickerState extends State<EmailRecipientPicker> {
